...
namespace Tools
{
    public static class SVNTool
    {
        ...
        {
            List<string> assetPaths = new List<string>(); assetPaths.Add(assetPath); UpdateAtPaths(assetPaths);
        }
        ...
        public static void UpdateAtPaths(List<string> assetPaths)
        {
            ...
            {
                var assetPath = assetPaths; if (i != 0)
                { arg += "*"; }
                arg += assetPath;
            }
        ...
        {
            List<string> assetPaths = SelectionUtil.GetSelectionAssetPaths(); UpdateAtPaths(assetPaths);
        }

        [MenuItem("Assets/SVN Tool/SVN 提交...")]
        private static void SvnToolCommit()
        {
            List<string> assetPaths = SelectionUtil.GetSelectionAssetPaths(); CommitAtPaths(assetPaths);
        }
